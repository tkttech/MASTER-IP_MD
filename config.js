...
STICKER_NAME: process.env.STICKER_NAME || "𝐌𝐀𝐒𝐓𝐄𝐑-𝐈𝐏_𝐌𝐃",
...
OWNER_NAME: process.env.OWNER_NAME || "*MASTER-IP Official*",
// add bot owner name
DESCRIPTION: process.env.DESCRIPTION || "*© ᴘᴏᴡᴇʀᴇᴅ ʙʏ MASTER-IP🇿🇼*",
// add bot owner name    
ALIVE_IMG: process.env.ALIVE_IMG || "https://files.catbox.moe/h48dlj.jpg",
// add img for alive msg
LIVE_MSG: process.env.LIVE_MSG || "> I'M ALIVE YOU PUSSY",
// add alive msg here 
